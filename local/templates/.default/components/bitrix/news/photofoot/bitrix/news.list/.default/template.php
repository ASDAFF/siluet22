...
<?foreach($arResult["ITEMS"] as $arItem):?>
    ...
    <div class="photo-report">
        <a href="<?=$arItem["DETAIL_PAGE_URL"]?>?p=on2" class="photo-report__img" style="background-image: url('<?=$arItem["DETAIL_PICTURE"]["SRC"]?>');">
        ...
        <div class="photo-report__content">
            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>?p=on2" class="photo-report__title"><?echo $arItem["NAME"]?></a>
