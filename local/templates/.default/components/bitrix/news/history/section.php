...
<br />
<?endif?>
<?$APPLICATION->IncludeComponent("bitrix:catalog.section.list", "histop2", Array(
...
<div class="tabs__content history__item active">
<!--start2-->
    <?
    $res = CIBlockSection::GetByID($arResult["VARIABLES"]["SECTION_ID"]);
    $ar_res = $res->GetNext();
    ?>
    <span class="history__year"><?echo $ar_res['NAME'];?></span>
