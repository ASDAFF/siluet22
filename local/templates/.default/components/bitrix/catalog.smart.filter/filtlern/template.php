...
?>
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter setting">
			...
			<?endforeach;?>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
                    ...
                    <div class="setting__cell">
							<span class="setting__title"><?=$arItem["NAME"]?>
							</span>
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default://CHECKBOXES
									?>
                                    <? echo $arItem["CONTROL_NAME_ALT"] ?>
                                <select id="<?=$arItem['CODE']; ?>" name="">
								<option value="" class="all">Все</option>
                                    <?foreach($arItem["VALUES"] as $val => $ar) { ?>

                                        <option <?echo $ar["CHECKED"]? 'selected="selected"': ''?>  id="<? echo $ar["CONTROL_NAME_ALT"] ?>" value="<?=$ar["HTML_VALUE_ALT"]?>" class="lg" <?if ($ar["DISABLED"]){ ?>disabled<? } ?>>
                                            <?echo $ar["VALUE"];?>
                                        </option>
...
$('#<?=$arItem['CODE']; ?>').prepend('');
        ...
        setTimeout(function(){
            var SelectOption = $("#<?=$arItem['CODE']; ?> option:not(.all)").attr('id');
