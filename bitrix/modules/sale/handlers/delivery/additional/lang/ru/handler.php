...
$MESS["SALE_DLVRS_ADD_LOC_INSTALL"] = "Для корректной работы обработчика службы доставки необходимо установить соответствие между местоположениями магазина и местоположениями службы доставки. В зависимости от производительности это может занять до 60 минут";
