...
if (!empty($arResult["SECTION"]["NEW_LINK"])):
	?><noinde><a rel="nofollow" href="<?=$arResult["SECTION"]["NEW_LINK"]?>" title="<?=GetMessage("P_ADD_ALBUM_TITLE")?>"  class="photo-action new-album" <?
...
if (!empty($arResult["SECTION"]["UPLOAD_LINK"])):
	?><noinde><a rel="nofollow" href="<?=$arResult["SECTION"]["UPLOAD_LINK"]?>" class="photo-action photo-upload"><?=GetMessage("P_UPLOAD")?></a></noindex><?
endif;
?>
