...
$MESS["T_IBLOCK_DESC_LIST_CONT"] = "Количество новостей";
...
$MESS["T_IBLOCK_DESC_LIST_HEIGHT_WINDOW"] = "Высота окна";
$MESS["T_IBLOCK_DESC_LIST_COLOR_TOP"] = "Цвет шапки окна";
$MESS["T_IBLOCK_DESC_NBRAINS_SORT"] = "Сортировка сначала";
$MESS["T_IBLOCK_DESC_NBRAINS_SORT_FIRST"] = "первые добавленные";
$MESS["T_IBLOCK_DESC_NBRAINS_SORT_LAST"] = "последние добавленные";
$MESS["T_IBLOCK_DESC_NBRAINS_STR_END_VALUE"] = "Конец";
$MESS["T_IBLOCK_DESC_NBRAINS_STR_END"] = "Надпись в конце";
$MESS["T_IBLOCK_DESC_NBRAINS_PRE_LOAD"] = "расположение значка загрузки от шапки в px";
?>